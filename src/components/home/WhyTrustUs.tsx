        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          {trustFeatures.map((feature, index) => (
            <motion.div
              ...
              className="flex flex-col items-center bg-[var(--background-dark-1)] rounded-xl p-8 hover:bg-[var(--background-dark-1)] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl"
            >
