export default function ProblemSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-1 gap-4 p-4 bg-[var(--background)] text-[var(--text-black)]">
      ...
      <div className="flex flex-col justify-center text-center md:text-left px-4 py-6 text-white">
        <h2 className="text-3xl md:text-3xl font-bold mb-4 text-[var(--primary-color)] tracking-wider">
